...
<head class="header">
  ...
  <!-- Titulo del tab -->
  <title>Bounce Padel - Renta de Canchas de Pádel</title>
</head>
        ...
        <div class="row h-100">
          ...
          <div class="col-md-7 text-center text-white mt-md-5" style="padding-right: 10px">
            ...
            <div id="carouselSectionPc" class="carousel slide my-5" data-bs-ride="carousel">
              ...
              <!-- Previo -->
              <button class="carousel-control-prev" type="button" data-bs-target="#carouselSectionPc" data-bs-slide="prev" style="padding-right: 50px; padding-top: 80px" id="carousel-control-prev-index">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Previous</span>
              </button>

              <!-- Siguiente -->
              <button class="carousel-control-next" type="button" data-bs-target="#carouselSectionPc" data-bs-slide="next" style="padding-left: 50px; padding-top: 80px" id="carousel-control-next-index">
