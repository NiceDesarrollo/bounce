                ...
                <div class="row">
                    <div class="col-md-6 text-center text-white mt-md-5 mt-5">
                        ...
                        <p class="mt-5 d-lg-none" style="padding-right: 55px; padding-left: 55px">
                            ...
                            practicar pádel o tienen interés en empezar.
                            <br>
                            Con nuestro espacio en el corazón de la ciudad, jugadores de todos los niveles encuentran un
                            lugar para aprender, ejercitarse y disfrutar con amigos y familiares. Únete a nuestra
                            emocionante aventura deportiva en Bounce Padel.
                        </p>
                                ...
                                <div class="carousel-item active">
                                    <div class="text-center">
                                        ...
                                        <p class="mt-1 justify-text" style="padding-right: 60px; padding-left: 60px">
                                            ...
                                            cafetería es el lugar perfecto para conectar con otros amantes del pádel.
                                        </p>
                                    </div>
                                </div>
