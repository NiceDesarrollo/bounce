...
<html lang="en">
  <head class="header">
    ...
    <meta
      property="og:title"
      content="Bounce Padel: Pasión por el Pádel en el corazón de Guadalajara"
    />
    <meta
    ...
    <meta
      ...
      content="Pasión por el Pádel en el corazón de Guadalajara"
    />
  ...
  <body style="background-color: #0f1f0fe9">
    ...
    <header>
      ...
      <div class="bg-image hero-image-background d-md-none">
        ...
        <nav class="navigation py-3">
          <a href="index.php" class="navbar-logo">
            <img
              src="./assets/Bounce_Blanco.png"
              alt="Logo pounce padel"
              loading="lazy"
            />
          </a>
          ...
          <div class="navbar-right text-center">
            ...
            <a href="#installationsPC" class="d-none d-lg-inline"
              >Instalaciones</a
            >
        ...
        >
          ...
          <div class="modal-dialog modal-lg pt-4" role="document">
            <div
              ...
              style="background-color: #0f1f0fe9"
            >
      ...
      <!-- hero desktop -->
      <div
        class="hero-desktop-loading hero-image-background-desktop d-none d-md-block"
      >
        <!-- Navegación-->
        <nav class="navigation py-3">
          ...
          <a
            ...
            href="https://playtomic.io/tenant/22ad955a-6248-4f43-aec0-fd46a63e969a?utm_source=app_ios&utm_medium=share"
            target="_blank"
            style="
        ...
        <a
          class="button-book-now shadow"
          href="https://playtomic.io/tenant/22ad955a-6248-4f43-aec0-fd46a63e969a?q=PADEL~2024-02-08~~~"
          target="_blank"
        >
          <button
            type="submit"
            class="btn btn-primary btn-sm button-form px-5 fs-5"
            id="buttonBookNow"
          >
            ¡RESERVAR AQUI!
          </button>
        ...
        <video autoplay muted loop>
          <source
            src="//vimeo-hp-videos.global.ssl.fastly.net/3/3.mp4"
            type="video/mp4"
          />
    ...
    <main>
        ...
        <div id="whoWeAre" class="bg-image who-we-are-image-background">
          <div class="row">
            <div class="col-md-6 text-center text-white mt-md-5 mt-5">
              ...
              <!-- Mobile text -->
              <p
                class="mt-5 d-lg-none"
                style="padding-right: 55px; padding-left: 55px"
              >
                ¡Somos unos apasionados por el deporte!
                <br />
                Nuestro objetivo es forjar una comunidad con todos aquellos que
                comparten nuestra pasión. Aspiramos a construir un espacio
                exclusivo para todas las personas que disfrutan de practicar
                pádel o tienen interés en empezar.
                <br />
                Con nuestro espacio en el corazón de la ciudad, jugadores de
                todos los niveles encuentran un lugar para aprender, ejercitarse
                y disfrutar con amigos y familiares. Únete a nuestra emocionante
                aventura deportiva en Bounce Padel.
              </p>

              <!-- pc text -->
              <p
                class="mt-5 justify-text text-desktop text-content-info"
                style="padding-right: 55px; padding-left: 55px"
              >
                ...
                las personas que disfrutan de practicar pádel o tienen interés
                en empezar. Con nuestro espacio en el corazón de la ciudad,
                jugadores de todos los niveles encuentran un lugar para
                aprender, ejercitarse y disfrutar con amigos y familiares. Únete
                a nuestra emocionante aventura deportiva en Bounce Padel.
              </p>
              ...
              <img
                height="30"
                width="30"
                src="./assets/SVG/Asset 6.svg"
                alt="Icono de pelota de tenis"
                onclick="handleClickBall(this)"
                loading="lazy"
      ...
      <section>
        <div
          id="installationsPC"
          class="bg-image installations-image-background d-none d-md-block"
        >
          <div class="row h-100">
            <div class="col-md-5 p-3" style="max-height: 100%">
              ...
              <img
                id="changingImage"
                src="./assets/images/cafeteria.webp"
                alt="Imagen 1"
            ...
            <div
              class="col-md-7 text-center text-white mt-md-5"
            ...
            >
              ...
              >
                <div class="carousel-inner">
                  ...
                  <div class="carousel-item active">
                    <div class="text-center">
                      ...
                      <p
                        class="mt-1 justify-text text-content-info"
                        style="padding-right: 60px; padding-left: 60px"
                      >
                        Cafeto Snack & Bar, un lugar para relajarse y compartir
                        momentos después del juego. Te ofrecemos diferentes
                        snacks, desde desayunos saludables hasta comidas
                        botaneras y bebidas para disfrutar después de un partido
                        de pádel. Ya sea para celebrar una victoria o
                        reflexionar sobre un partido, nuestra cafetería es el
                        lugar perfecto para conectar con otros amantes del
                        pádel.
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="carousel-item">
                    <div class="text-center">
                      ...
                      <p
                        ...
                        style="padding-right: 60px; padding-left: 60px"
                      >
                        Modernos y equipados con todo lo que necesitas para
                        prepararte y relajarte antes y después de tu juego.
                        Disfruta de vestidores, regaderas y lockers
                  ...
                  <div class="carousel-item">
                    <div class="text-center">
                      ...
                      <p
                        ...
                        style="padding-right: 60px; padding-left: 60px"
                      >
                        Contamos con regaderas modernas totalmente equipadas
                        para tu comodidad. Te ofrecemos funcionalidad para
                        relajarte después de tu juego.
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="carousel-item">
                    <div class="text-center">
                      ...
                      <p
                        ...
                        style="padding-right: 60px; padding-left: 60px"
                      >
                        Contamos con estacionamiento privado para que puedas
                        disfrutar de tu experiencia sin preocupaciones. Un lugar
                        conveniente para estacionar tu vehículo, asegurando una
                ...
                <button
                  ...
                  type="button"
                  data-bs-target="#carouselSectionPc"
                  data-bs-slide="prev"
                  style="padding-right: 50px; padding-top: 80px"
                  id="carousel-control-prev-index"
                >
                  <span
                ...
                <button
                  ...
                  data-bs-target="#carouselSectionPc"
                  data-bs-slide="next"
                  style="padding-left: 50px; padding-top: 80px"
                  id="carousel-control-next-index"
                >
                  <span
        ...
        >
          <div class="carousel-inner">
            ...
            <div class="mobile carousel-item active">
              ...
              />
              <div
                class="carousel-caption d-flex h-100 align-items-center justify-content-center pt-5"
              >
                <div class="mt-5">
            ...
            <div class="mobile carousel-item">
              <img
                src="./assets/images/canchas.webp"
                class="d-block w-100 h-100"
                alt="Cafetería"
              />
              <div
                class="carousel-caption d-flex h-100 align-items-center justify-content-center"
              >
            ...
            <div class="mobile carousel-item">
              <img
                src="./assets/images/vestidores.webp"
                class="d-block w-100 h-100"
                alt="Cafetería"
              />
              <div
            ...
            <div class="mobile carousel-item">
              <img
                src="./assets/images/regaderas.webp"
                class="d-block w-100 h-100"
                alt="Cafetería"
              />
              <div
              ...
              >
                <div>
                  ...
                  <p>
                    Contamos con regaderas modernas totalmente equipadas para tu
                    comodidad. Te ofrecemos funcionalidad para relajarte después
                    de tu juego.
                  </p>
                </div>
              </div>
            ...
            <div class="mobile carousel-item">
              <img
                src="./assets/images/estacionamiento.webp"
                class="d-block w-100 h-100"
                alt="Cafetería"
              />
              <div
          ...
          <button
            class="carousel-control-prev"
            type="button"
            data-bs-target="#carouselSectionMobile"
            data-bs-slide="prev"
          >
          ...
          <div class="row">
            <div class="col-md-6 text-center text-white mt-5 text-content-info">
              ...
              >
                <button
                  type="submit"
                  class="btn btn-primary btn-sm button-form px-2"
      ...
      <section>
        <div id="shop" class="bg-image tournament-image-background">
          <div class="row">
            <div class="col-md-6 text-center text-white pr-3"></div>
            <div
              class="col-md-6 text-center text-white mt-md-5 mt-5 text-content-info"
            >
              ...
              >
                ...
                <a href="#services">
                  <button
                    type="submit"
                    class="btn btn-primary btn-sm button-form px-4 py-2"
                  >
                    CONTÁCTANOS
                    <i
                      class="fa-brands fa-whatsapp fa-2xl my-2"
                      style="color: white; padding-left: 10px"
                      id="whatsappIconTournamentMobile"
                    ></i>
                  </button>
                </a>
              </div>
              ...
              <!-- pc text -->
              <div
                class="mt-5 justify-text text-desktop text-center"
                style="padding-right: 55px; padding-left: 55px"
              >
                <h5>
                  ¡Organiza tu propio torneo de pádel con nosotros y lleva la
        ...
        <div id="whoWeAre" class="bg-image academy-image-background">
          <div class="row">
            <div class="col-md-6 text-center text-white mt-5 text-content-info">
              ...
              <!-- Mobile text -->
              <div
                class="mt-5 d-lg-none text-center"
                style="padding-right: 55px; padding-left: 55px"
              >
                ...
                <p>
                  ...
                  niveles. Nuestros entrenadores altamente capacitados te
              ...
              <!-- pc text -->
              <div
                class="justify-text text-desktop text-center mt-5"
                style="padding-right: 55px; padding-left: 55px"
              >
                <h5>¡Descubre el mundo del pádel en nuestra academia!</h5>
                <p>
          ...
          <div class="row">
            ...
            >
              ...
              <p
                ...
                style="padding-right: 55px; padding-left: 55px"
              >
                Encuentra todo lo que necesitas para mejorar tu juego. Desde
                raquetas hasta calzado, nuestros expertos te ayudarán a elegir
                lo mejor para ti. ¡Prepárate para brillar en la cancha con
                nosotros!
              </p>
              <!-- pc text -->
              <p
                class="mt-5 justify-text text-desktop"
                style="padding-right: 55px; padding-left: 55px"
              >
                Encuentra todo lo que necesitas para mejorar tu juego. Desde
                raquetas hasta calzado, nuestros expertos te ayudarán a elegir
      ...
      <section>
        <div id="contact" class="bg-image contact-image-background">
          <div class="row">
            ...
            <div
              class="col-md-6 text-white d-flex flex-column align-items-center mt-md-5 mt-5"
            >
              <?php
              ...
              >
                ...
                <div class="pt-2 px-2">Hubo un problema con el recaptcha</div>
                <button
                  type="button"
                  class="btn-close"
              ...
              >
                ...
                <div class="pt-2 px-2">Correo enviado exitosamente</div>
                <button
                  type="button"
                  class="btn-close"
                  data-bs-dismiss="alert"
              ...
              <form action="form.php" method="POST" class="w-75">
                ...
                <div
                  ...
                  data-sitekey="6LeqmFspAAAAAHrADuvHzFH8uR3P_jpffd-GKx_R"
                  data-theme="dark"
                ...
                <div class="mt-2 d-flex justify-content-end">
                  <button
                    type="submit"
                    class="btn btn-primary btn-sm button-form px-4"
                    value="submit"
                    id="buttonSendForm"
                    disabled="disabled"
                  >
      ...
      <a
        href="https://api.whatsapp.com/send?phone=51955081075&text=Hola."
      ...
      <section>
        <footer class="bg-black">
          <div class="row px-4">
            ...
            <!-- Menu footer -->
            <div
              class="col-lg-6 text-center text-white mt-5 d-flex flex-wrap navbar-footer"
            >
              <a href="#whoWeAre" class="flex-grow-1">¿Quiénes somos?</a>

              <!-- Enlace a carousel de instalaciones (Mobile) -->
              <a
                href="#carouselSectionMobile"
                class="flex-grow-1 d-md-block d-lg-none"
                >Instalaciones</a
              >

              <!-- Enlace a carousel de instalaciones (PC) -->
              <a href="#installationsPC" class="flex-grow-1 d-none d-lg-block"
                >Instalaciones</a
              >
    ...
    <!-- Font awesome link -->
    <script
      src="https://kit.fontawesome.com/3a2bbc5bd5.js"
      crossorigin="anonymous"
    ></script>
